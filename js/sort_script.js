let randomize_Array = document.getElementById("randomize_array_btn");// Generate btn
...
async function heapSort(array) {
  ...
  async function heap(array, n, i) {
    ...
    if (largest != i) {
      await hswap(array, i, largest, bars);
      await heap(array, n, largest);
    }
  }
  
  async function hswap(array, i, j, bars) {
    if(flag)
      return;
    let temp = array[i];
    array[i] = array[j];
